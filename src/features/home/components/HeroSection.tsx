  ...
  return (
    <section className="min-h-dvh flex items-center justify-center pt-5 sm:pt-20 px-6 md:px-8">
      <div className="max-w-6xl mx-auto text-center space-y-8">
        {/* Badge */}
        <AnimatedReveal isVisible={true} isInitialLoad={isInitialLoad} delay={0} className="inline-flex items-center gap-2 bg-cyan-500/20 border border-cyan-500/50 rounded-full px-4 py-2">
        ...
        <AnimatedReveal isVisible isInitialLoad={isInitialLoad} delay={0.15}>
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black bg-linear-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent mb-6 leading-tight">
        ...
        {/* CTA Buttons */}
        <AnimatedReveal isVisible isInitialLoad={isInitialLoad} delay={0.45} className="flex flex-col md:flex-row gap-4 justify-center pt-4">
          <button
        ...
        {/* Stats */}
        <AnimatedReveal isVisible isInitialLoad={isInitialLoad} delay={0.6} className="grid grid-cols-3 gap-4 pt-8 max-w-2xl mx-auto">
