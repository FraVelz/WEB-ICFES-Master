        ...
        <LecturaSectionShell sectionId="importancia">
          ...
          <aside className="border-app-ring/20 bg-surface-elevated/60 rounded-2xl border p-6">
            <p className="text-on-surface leading-relaxed">
              Prepararte con método —ya sea para el Saber 11° o para la Prueba de Validación— es invertir en más
              opciones para tu futuro. <strong className="text-app-accent font-semibold">ICFES Master</strong> está aquí
              para ayudarte con práctica, simulacros y una ruta de aprendizaje guiada{' '}
