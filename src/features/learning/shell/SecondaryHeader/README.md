# SecondaryHeader — documentación

> **Nota (2026):** el componente se llama `SecondaryHeader` y vive en `src/features/learning/shell/SecondaryHeader/`. Las referencias antiguas a `MobileHeader` o `components/MobileHeader` están obsoletas.

## 📱 Descripción general

El **SecondaryHeader** es un componente interactivo tipo Duolingo para la página de Ruta de Aprendizaje. Se muestra solo en dispositivos móviles (hidden en desktop) y contiene 3 elementos principales clickeables que despliegan modales con información detallada del usuario.
