...
export const CTASection = () => {
  return (
    <div className="mb-20 rounded-2xl bg-linear-to-r from-blue-600 to-purple-600 p-8 text-center">
      ...
      <h3 className="mb-2 text-2xl font-bold text-white">¿Listo para tu preparación ICFES?</h3>
      ...
      <div>
        <MascotaCircle src="/avatars/celebrando.webp" alt="Mascota feliz" size="large" centered className="mb-4" />
      </div>
    </div>
  );
};
