    ...
    <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-3">
      ...
      <div className="rounded-xl border border-green-600/30 bg-slate-800/50 p-6">
        ...
        <p className="text-sm text-slate-400">
          <strong>Objetivo:</strong> Domina conceptos fundamentales de
          Matemáticas, Lenguaje, Ciencias Naturales, Ciencias Sociales e Inglés,
          para el ICFES.
        </p>
      ...
      <div className="rounded-xl border border-yellow-600/30 bg-slate-800/50 p-6">
        ...
        <p className="text-sm text-slate-400">
          <strong>Objetivo:</strong> Practica exámenes específicos por materia
          con evaluación inmediata
        </p>
      ...
      <div className="rounded-xl border border-red-600/30 bg-slate-800/50 p-6">
        ...
        <p className="text-sm text-slate-400">
          <strong>Objetivo:</strong> Resuelve el examen completo bajo
          condiciones reales
        </p>
