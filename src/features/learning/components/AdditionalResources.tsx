...
export const AdditionalResources = () => {
  return (
    <section className="mb-24">
      <div className="border-cyan-400 bg-linear-to-br from-blue-600 via-purple-600 to-cyan-600 p-12 shadow-2xl sm:mx-6 sm:rounded-3xl sm:border-4">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <button className="cursor-pointer rounded-xl border-2 border-white bg-white/20 px-8 py-3 font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-white/30 hover:shadow-lg">
            Ver Videos
          </button>
        </div>
      </div>
