...
const PRACTICE_BUTTON_STYLES: Record<SubjectTone, { light: string; dark: string }> = {
  lc: {
    light:
      'border-blue-600/55 bg-white text-blue-900 shadow-sm hover:border-blue-700 hover:bg-blue-50',
  ...
  math: {
    light:
      'border-green-600/55 bg-white text-green-900 shadow-sm hover:border-green-700 hover:bg-green-50',
  ...
  sci: {
    light:
      'border-purple-600/55 bg-white text-purple-900 shadow-sm hover:border-purple-700 hover:bg-purple-50',
  ...
  soc: {
    light:
      'border-orange-600/55 bg-white text-orange-950 shadow-sm hover:border-orange-700 hover:bg-orange-50',
  ...
  eng: {
    light:
      'border-indigo-600/55 bg-white text-indigo-900 shadow-sm hover:border-indigo-700 hover:bg-indigo-50',
  ...
  full: {
    light:
      'border-pink-600/55 bg-white text-pink-900 shadow-sm hover:border-pink-700 hover:bg-pink-50',
