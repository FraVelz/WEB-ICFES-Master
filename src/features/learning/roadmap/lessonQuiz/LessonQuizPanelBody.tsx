  ...
  return (
    <div
      className={cn(
        ...
        'scrollbar-thumb-surface-border scrollbar-thin scrollbar-track-transparent',
      ...
      {isCard ? (
        ...
        <>
          ...
          <div className="mb-4 flex justify-center sm:mb-6">
            <span
              className={cn(
                'bg-surface-overlay/80 text-on-surface-muted rounded-full px-3 py-1 text-xs font-semibold tracking-wider',
                'uppercase'
              )}
            >
