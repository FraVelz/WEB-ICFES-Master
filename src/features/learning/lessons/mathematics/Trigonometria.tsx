    ...
    topics: [
      {
        ...
        description:
          'Seno, coseno y tangente en triángulos rectángulos y en el círculo unitario.',
        subtopics: [
      ...
      },
      {
        ...
        description:
          'Relaciones fundamentales y derivadas entre funciones trigonométricas.',
        subtopics: [
      ...
      },
      {
        ...
        description:
          'Resolución de ecuaciones que contienen funciones trigonométricas.',
        subtopics: [
          'Ecuaciones simples',
