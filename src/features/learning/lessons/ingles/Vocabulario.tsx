    ...
    topics: [
      {
        ...
        examples: ['"Actually" = en realidad, no "actualmente" (currently).', '"Sensitive" ≠ sensible (reasonable).'],
      },
      {
    ...
    <div className="min-h-dvh bg-linear-to-br from-gray-900 via-slate-900 to-gray-900 text-white">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 py-10">
        ...
        <section className="mb-16">
          <h2 className="mb-8 text-3xl font-bold text-app-accent">Formación de palabras</h2>
