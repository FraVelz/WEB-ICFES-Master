  ...
  const content = {
    ...
    topics: [
      ...
      },
      {
        ...
        subtopics: ['Going to: intención previa', 'Will: decisión en el momento', 'Present continuous: arreglo fijado'],
  ...
  return (
    <div className="min-h-dvh bg-linear-to-br from-gray-900 via-slate-900 to-gray-900 text-white">
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/4 h-96 w-96 animate-pulse rounded-full bg-ambient-c/20 blur-3xl"></div>
        <div className="absolute right-1/4 bottom-0 h-96 w-96 animate-pulse rounded-full bg-lesson-eng-glow-b/20 blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 py-10">
          ...
          {content.topics.map((topic, idx) => (
            ...
            >
              ...
              <div className="grid gap-8 md:grid-cols-2">
                <div>
                  <h3 className="mb-4 text-xl font-semibold text-blue-400">Cuándo usar cada tiempo</h3>
        ...
        <section className="mb-16">
          <h2 className="mb-8 text-3xl font-bold text-app-accent">Estructuras frecuentes</h2>
