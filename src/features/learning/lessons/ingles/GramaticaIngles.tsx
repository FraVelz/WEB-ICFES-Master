    ...
    topics: [
      {
        ...
        subtopics: ['Present simple (habits, facts)', 'Present continuous (now, temporary)', 'Adverbs of frequency'],
    ...
    <div className="min-h-dvh bg-linear-to-br from-gray-900 via-slate-900 to-gray-900 text-white">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 py-10">
          ...
          {content.topics.map((topic, idx) => (
            ...
            >
              ...
              <div className="grid gap-8 md:grid-cols-2">
                <div>
                  <h3 className="mb-4 text-xl font-semibold text-blue-400">Ideas clave</h3>
        ...
        <section className="mb-16">
          <h2 className="mb-8 text-3xl font-bold text-app-accent">Patrones útiles</h2>
