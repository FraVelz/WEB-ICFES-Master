    ...
    topics: [
      {
        ...
        description:
          'Conceptos fundamentales de temperatura, calor y equilibrio térmico.',
        subtopics: [
        ...
        examples: [
          'T(K) = T(°C) + 273',
          'Q = m·c·ΔT',
          'Conducción en metales, convección en fluidos',
        ],
      },
      {
        name: 'Leyes de la Termodinámica',
        description:
          'Principios fundamentales que rigen los procesos termodinámicos.',
        subtopics: [
