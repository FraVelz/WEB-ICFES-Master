    ...
    topics: [
      {
        ...
        description:
          'Historia de civilizaciones indígenas antes de la conquista española.',
        subtopics: [
      ...
      },
      {
        name: 'Época Colonial',
        description:
          'Dominio español y cambios socioculturales en el territorio.',
        subtopics: [
        ...
        examples: [
          ...
          'Fundación de Cartagena y Bogotá',
