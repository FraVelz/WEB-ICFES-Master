...
export const Historia = () => {
  const content = {
    title: 'Historia de Colombia', duration: '7-8 horas', lessons: 20, difficulty: 'fácil', topics: [
      {
        name: 'Periodo Precolombino', description: 'Historia de civilizaciones indígenas antes de la conquista española.', subtopics: [
          'Pueblos indígenas: Muiscas, Taironas, Quimbayas', 'Organización social y política', 'Avances tecnológicos y artísticos', 'Sistemas de gobierno'
        ], examples: [
          'Muiscas: confederación de cacicazgos', 'Cultura Tayrona: ciudades en la sierra', 'Cerámica y orfebrería avanzada'
        ]
      }, {
        name: 'Época Colonial', description: 'Dominio español y cambios socioculturales en el territorio.', subtopics: [
          'Conquista y colonización', 'Encomienda y sistemas de trabajo', 'Mestizaje y mezcla cultural', 'Estructuras coloniales'
        ], examples: [
          'Llegada de Colón en 1492', 'Fundación de Cartagena y Bogotá', 'Virreinato de Nueva Granada'
        ]
      }, {
        name: 'República', description: 'Independencia y formación del estado colombiano moderno.', subtopics: [
          'Movimientos independentistas', 'Proceso de emancipación', 'Constituciones y reformas políticas', 'Conflictos internos y bipartidismo'
        ], examples: [
          'Grito de Independencia: 20 de julio', 'Constitución de 1886', 'Frente Nacional (1958-1974)'
        ]
      }
    ], keyFormulas: [
      '1492: Llegada de Colón', '1810: Grito de Independencia', '1819: Batalla de Boyacá', '1886: Constitución Política'
    ], practiceExercises: [
      'Identificar principales pueblos indígenas', 'Explicar sistema de encomienda', 'Enumerar próceres de la independencia', 'Analizar período colonial vs república'
    ]
  };
    ...
    <div className="min-h-[100dvh] bg-linear-to-br from-gray-900 via-slate-900 to-gray-900 text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-10">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-cyan-400 mb-8">Hitos Importantes</h2>
