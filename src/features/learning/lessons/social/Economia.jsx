...
export const Economia = () => {
  const content = {
    title: 'Economía', duration: '7-8 horas', lessons: 19, difficulty: 'medio', topics: [
      {
        name: 'Sistemas Económicos', description: 'Clasificación y características de los principales sistemas económicos.', subtopics: [
          'Capitalismo y libre mercado', 'Socialismo y economía planificada', 'Economía mixta', 'Modelos económicos actuales'
        ], examples: [
          'EE.UU.: economía capitalista', 'Mercados: determinan precios', 'Estado: regula en economía mixta'
        ]
      }, {
        name: 'Oferta y Demanda', description: 'Mecanismos fundamentales del mercado y formación de precios.', subtopics: [
          'Ley de oferta y demanda', 'Equilibrio de mercado', 'Elasticidad', 'Desplazamientos de curvas'
        ], examples: [
          'Demanda ↑ → Precio ↑', 'Oferta ↑ → Precio ↓', 'Equilibrio: cantidad demandada = ofrecida'
        ]
      }, {
        name: 'Indicadores Económicos', description: 'Medidas clave para evaluar la salud de una economía.', subtopics: [
          'PIB (Producto Interno Bruto)', 'Inflación y deflación', 'Desempleo', 'Balanza comercial'
        ], examples: [
          'PIB Colombia 2023: ~$315 mil millones', 'Inflación: aumento general de precios', 'Desempleo: porcentaje sin trabajo'
        ]
      }
    ], keyFormulas: [
      'Demanda: D = f(Precio)', 'Oferta: S = f(Precio)', 'Equilibrio: Qd = Qs', 'Inflación = (IPC_actual - IPC_anterior) / IPC_anterior × 100'
    ], practiceExercises: [
      'Graficar curvas de oferta y demanda', 'Calcular cambios de precio por exceso/escasez', 'Analizar efecto de inflación', 'Comparar sistemas económicos'
    ]
  };
    ...
    <div className="min-h-[100dvh] bg-linear-to-br from-gray-900 via-slate-900 to-gray-900 text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-10">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-cyan-400 mb-8">Conceptos Fundamentales</h2>
