...
export const Geografia = () => {
  const content = {
    title: 'Geografía Política', duration: '6-7 horas', lessons: 18, difficulty: 'fácil', topics: [
      {
        name: 'División Política', description: 'Organización territorial y divisiones administrativas mundiales.', subtopics: [
          'Continentes y océanos', 'Países y fronteras', 'Regiones administrativas', 'Geopolítica'
        ], examples: [
          '6 continentes: África, América, Asia, Europa, Oceanía, Antártida', '195 países reconocidos en el mundo', 'Colombia: 32 departamentos + Bogotá'
        ]
      }, {
        name: 'Geografía de Colombia', description: 'Características geográficas y territoriales de Colombia.', subtopics: [
          'Regiones naturales: Caribe, Pacífica, Andina, Orinoquía, Amazonía', 'Cordilleras andinas', 'Costas atlántica y pacífica', 'Recursos naturales y biodiversidad'
        ], examples: [
          '1.3 millones km² de territorio', 'Segunda mayor biodiversidad mundial', 'Capital: Bogotá D.C.'
        ]
      }, {
        name: 'Recursos Naturales', description: 'Distribución y aprovechamiento de recursos en el planeta.', subtopics: [
          'Recursos renovables y no renovables', 'Petróleo, minerales, agua', 'Bosques y flora', 'Fauna y ecosistemas'
        ], examples: [
          'Petróleo: recurso no renovable', 'Agua: recurso renovable esencial', 'Bosques tropicales: biodiversidad'
        ]
      }
    ], keyFormulas: [
      'Área total Colombia: 1.141.748 km²', 'Población: ~50 millones', '32 departamentos + capital', 'Posición: 4°-5° biodiversidad mundial'
    ], practiceExercises: [
      'Localizar continentes y océanos en mapa', 'Identificar las 5 regiones naturales', 'Enumerar departamentos colombianos', 'Analizar distribución de recursos'
    ]
  };
    ...
    <div className="min-h-dvh bg-linear-to-br from-gray-900 via-slate-900 to-gray-900 text-white">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-10">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-cyan-400 mb-8">Datos Importantes</h2>
