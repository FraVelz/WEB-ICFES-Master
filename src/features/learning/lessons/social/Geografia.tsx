    ...
    topics: [
      {
        ...
        description:
          'Organización territorial y divisiones administrativas mundiales.',
        subtopics: [
      ...
      },
      {
        ...
        examples: [
          '1.3 millones km² de territorio',
          'Segunda mayor biodiversidad mundial',
          'Capital: Bogotá D.C.',
        ],
      },
      {
        ...
        description:
          'Distribución y aprovechamiento de recursos en el planeta.',
        subtopics: [
