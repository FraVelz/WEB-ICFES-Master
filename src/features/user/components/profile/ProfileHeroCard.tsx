...
export function ProfileHeroCard({
  ...
  return (
    <div
      className={cn(
        'relative mb-8 overflow-visible rounded-3xl border border-surface-border bg-surface-elevated/90 p-6',
    ...
    >
      ...
      <div className="flex flex-col items-center gap-8 md:flex-row">
        <div className="group relative shrink-0 overflow-visible pb-3 pr-3 md:pb-4 md:pr-4">
          <div
            className={cn(
              'h-32 w-32 rounded-full border-4 bg-surface-via p-1 shadow-lg md:h-40 md:w-40',
              'dark:bg-slate-950',
              isVip
          ...
          >
            <div className="relative h-full w-full overflow-hidden rounded-full bg-surface-elevated dark:bg-slate-800">
          ...
          <div
            className={cn(
              'absolute right-0 bottom-0 z-10 rounded-full border px-3 py-1 text-xs font-bold whitespace-nowrap shadow-md',
              'border-surface-border bg-surface-elevated dark:border-slate-700 dark:bg-slate-900',
              accent === 'purple' ? 'text-purple-700 dark:text-purple-400' : 'text-app-accent-strong dark:text-app-accent'
            )}
          >
        ...
        <div className="flex-1 space-y-3 text-center md:text-left">
          <div className="flex flex-wrap items-center justify-center gap-3 md:justify-start">
            <h1 className="text-3xl font-bold text-on-surface md:text-4xl">{name}</h1>
            {isVip && <ProfileVipBadge />}
          </div>
          <p className="text-lg text-on-surface-muted italic">&quot;{personalPhrase}&quot;</p>
          <div className="flex items-center justify-center gap-4 pt-2 text-sm text-on-surface-muted md:justify-start">
          ...
          <div className="mt-4 max-w-md">
            ...
            <div className="h-4 overflow-hidden rounded-full border border-surface-border bg-surface-via shadow-inner dark:border-slate-700 dark:bg-slate-800">
              <div
                className={cn(
            ...
            <div className="mt-2 flex items-center justify-between text-xs">
              <div className="flex items-center gap-2">
                <span className="font-semibold text-on-surface">Nivel {levelInfo?.level ?? level}</span>
