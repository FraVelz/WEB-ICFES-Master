      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        {glowVariant === 'public' ? (
          <>
            ...
            <div className="bg-app-ring/10 dark:bg-app-ring/10 absolute top-1/4 left-0 h-96 w-96 rounded-full blur-3xl" />
          </>
        ) : (
          <>
            <div className="from-hub-sheet-from/30 dark:from-hub-sheet-from/20 absolute top-0 left-0 h-96 w-full bg-linear-to-b to-transparent" />
