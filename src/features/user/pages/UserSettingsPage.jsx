  ...
  const handleSupportSubmit = async (e) => {
    ...
    try {
      ...
      const supportData = {
        ...
        email: supportMode === 'response' ? supportEmail : 'anonymous',
        type: supportMode,
      ...
      showMessage('Gracias 🙌 Tu mensaje fue enviado correctamente.', 'success');
      setSupportMessage('');
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="p-4 rounded-xl bg-slate-950/50 border border-slate-800">
                    ...
                    <p className="text-xs text-slate-400 leading-relaxed">
                      Tus datos se sincronizan automáticamente en la nube de Google Firestore. Accede desde cualquier dispositivo.
                    </p>
                  </div>
                  <div className="p-4 rounded-xl bg-slate-950/50 border border-slate-800">
                    <h3 className="font-bold text-white mb-2 flex items-center gap-2">
