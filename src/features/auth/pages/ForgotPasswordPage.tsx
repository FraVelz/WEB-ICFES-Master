  ...
  return (
    <div className={cn('flex min-h-full items-center justify-center px-6 py-12', FULL_PAGE_SHELL_CLASS)}>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Link
          href="/login"
          className="text-on-surface-muted hover:text-on-surface-muted mb-8 inline-flex items-center gap-2 transition-colors"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  'border-surface-border bg-surface-overlay/50 w-full rounded-lg border py-3 pr-4 pl-10 transition-all',
          ...
          {error ? (
            <div className="flex items-start gap-3 rounded-lg border border-red-500/50 bg-red-500/20 p-4" role="alert">
