  ...
  useEffect(() => {
    ...
    AuthService.verifyResetCode(code)
      ...
      .catch((err) => {
        ...
        setError('Este enlace de recuperación ha expirado o es inválido. Por favor, solicita uno nuevo.');
        setVerifying(false);
      });
  }, [searchParams]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.code === 'auth/expired-action-code') {
        setError(EMAIL_MESSAGES.resetPasswordPage.errorExpiredLink);
      } else if (err.code === 'auth/invalid-action-code') {
        setError(EMAIL_MESSAGES.resetPasswordPage.errorInvalidLink);
      } else {
