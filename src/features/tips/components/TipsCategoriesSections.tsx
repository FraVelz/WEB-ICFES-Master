    ...
    <>
      ...
      >
        <TipCard
          ...
          description="Estudia en sesiones cortas con descansos de 5–10 minutos. Es más sostenible que maratones de horas y mejora la retención."
        />
        <TipCard
          title="Prioriza por área débil"
          description="Dedica más tiempo a las materias donde obtienes menos aciertos. Revisa tus estadísticas en ICFES Master para identificarlas."
        />
        <TipCard
          title="Horario fijo diario"
          description="Elige un momento del día (mañana, tarde o noche) y respétalo como una cita. La constancia importa más que la cantidad de horas."
        />
        <TipCard
          title="Plan semanal realista"
          description="Distribuye simulacros, práctica por área y repaso. Deja al menos un día de descanso activo para evitar el agotamiento."
        />
      </TipsCategorySection>
      ...
      >
        <TipCard
          ...
          description="Resuelve preguntas en lugar de releer apuntes. La práctica con retroalimentación es lo que más sube tu puntaje."
        />
        <TipCard
          title="Aprende de los errores"
          description="Lee siempre la explicación de las preguntas incorrectas. Anota el patrón del error para no repetirlo."
        />
        <TipCard
          title="Resume con tus palabras"
          description="Después de una lección, explica el concepto en voz alta o por escrito. Si no puedes explicarlo, repasa."
        />
        <TipCard
          title="Alterna tipos de ejercicio"
          description="Combina lecciones del roadmap, práctica por área y simulacros completos. La variedad mantiene el cerebro activo."
        />
      </TipsCategorySection>
      ...
      >
        <TipCard
          ...
          description="Familiarízate con el número de preguntas, tiempos y áreas evaluadas. Los simulacros de la app replican esa estructura."
        />
        <TipCard
          title="Domina el manejo del tiempo en el simulacro"
          description="Practica con cronómetro. Si una pregunta te bloquea, márcala y sigue; vuelve al final si queda tiempo."
        />
        <TipCard
          title="Refuerza lectura crítica"
          description="Muchas áreas dependen de comprender bien el enunciado. Lee con calma y subraya datos clave antes de responder."
        />
        <TipCard
          title="Repasa fórmulas y conceptos base"
          description="En matemáticas y ciencias naturales, ten a mano las fórmulas que más aparecen y practícalas con contexto, no de memoria aislada."
        />
      </TipsCategorySection>
      ...
      >
        ...
        <TipCard
          ...
          description="Revisa tus logros y nivel en la app. Ver progreso concreto refuerza la motivación más que compararte solo con el puntaje final."
        />
        <TipCard
        ...
        <TipCard
          title="Descansa bien"
          description="Dormir 7–8 horas mejora memoria y concentración. Estudiar cansado es menos eficiente que una sesión corta descansado."
        />
      </TipsCategorySection>
      ...
      >
        ...
        <TipCard
          ...
          description="En preguntas de selección múltiple, descarta las opciones claramente incorrectas y elige entre las que quedan."
        />
        <TipCard
          title="No te quedes atascado"
          description="Si no sabes una respuesta, elige la más razonable y avanza. Es mejor responder todo que dejar preguntas en blanco sin intentar."
        />
      </TipsCategorySection>
    </>
  );
