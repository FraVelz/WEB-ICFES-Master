            ...
            <div className="space-y-6 lg:col-span-3">
              {questions.map((question, index) => (
                <div
                  ...
                  id={`question-${index}`}
                  className={cn(
                    'border-white/10 bg-linear-to-br from-gray-800/40 via-gray-900/40 to-gray-950/40 p-6',
                    'shadow-lg backdrop-blur-md transition-all duration-300 hover:border-white/20',
                    'hover:shadow-xl sm:rounded-xl sm:border'
                  )}
                >
