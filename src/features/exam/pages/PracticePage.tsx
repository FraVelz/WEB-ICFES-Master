...
const AREA_INFO = {
  'lectura-critica': { name: 'Lectura Crítica', color: 'from-blue-400 to-blue-600' },
  'matematicas': { name: 'Matemáticas', color: 'from-green-400 to-green-600' },
  'ciencias-naturales': { name: 'Ciencias Naturales', color: 'from-purple-400 to-purple-600' },
  'sociales-ciudadanas': { name: 'Sociales y Ciudadanas', color: 'from-orange-400 to-orange-600' }
};
...
export const PracticePage = () => {
  ...
  }, [isFinished, showResults, questions, answers, examConfig, area, areaInfo.name]);

  if (!examConfig) {
    return <ExamConfigModal area={area} onStart={handleExamStart} />;
  }
