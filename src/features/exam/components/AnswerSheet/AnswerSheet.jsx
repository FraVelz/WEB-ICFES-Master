export const AnswerSheet = ({ totalQuestions, answers, currentQuestion, onQuestionClick }) => {
 return (
 ...
 className={`aspect-square flex items-center justify-center rounded-lg font-bold text-xs transition-all duration-300 ${isCurrent
