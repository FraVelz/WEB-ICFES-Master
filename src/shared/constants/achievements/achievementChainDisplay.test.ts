...
import { organizeChainViewsForDisplay, resolveAchievementChainViews, getAchievementChainSummary } from './achievementChainDisplay';

describe('resolveAchievementChainViews', () => {
  const sample = [
    { id: 'study_1', category: 'estudio', group: 'estudio_general', status: 'completed', progress: 5, target: 5, title: 'T1', icon: 'book' },
    { id: 'study_2', category: 'estudio', group: 'estudio_general', status: 'in_progress', progress: 1, target: 20, title: 'T2', icon: 'book' },
    { id: 'perf_1', category: 'rendimiento', group: 'rendimiento_resultados', status: 'incomplete', progress: 0, target: 1, title: 'Perf', icon: 'brain' },
  ];
