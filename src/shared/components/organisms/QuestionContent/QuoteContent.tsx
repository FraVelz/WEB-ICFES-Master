 ...
 * />
 */
export const QuoteContent = ({ text, author = null, source = null, type = "quote" }) => {
  const isQuote = type === "quote";

  return (
    <blockquote
      className={`my-6 pl-6 py-4 pr-4 rounded-lg border-l-4 ${
        isQuote
    ...
    >
      ...
      {author && (
        <p className={`mt-3 text-xs font-semibold ${isQuote ? 'text-blue-300' : 'text-amber-300'}`}>
          — {author}
        </p>
      )}
      {source && (
