  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            'flex h-full w-full max-w-3xl flex-col overflow-hidden rounded-none border-0',
            'border-white/20 bg-linear-to-br from-slate-900 to-slate-950 shadow-2xl sm:h-auto',
            'sm:max-h-[85vh] sm:w-full sm:rounded-3xl sm:border md:max-h-[80vh] md:max-w-4xl'
          )}
        >
          {/* Header */}
          <div
            className={cn(
              'flex shrink-0 items-center justify-between border-b border-white/10 bg-linear-to-r',
              'from-slate-900/50 to-slate-950/50 p-6 sm:p-8 md:p-10'
            )}
          >
          ...
          {/* Body */}
          <div className="flex-1 overflow-y-auto p-6 sm:p-8 md:p-10">{children}</div>
          ...
          <div className="flex shrink-0 justify-end border-t border-white/10 bg-linear-to-r from-slate-950/50 to-slate-900/50 p-6 sm:p-8 md:p-10">
            <Button
              onClick={onClose}
              className={cn(
                'cursor-pointer bg-linear-to-r from-blue-600 to-blue-700 transition-all duration-300',
                'hover:from-blue-700 hover:to-blue-800 hover:shadow-lg hover:shadow-blue-500/50'
              )}
            >
              Cerrar
            </Button>
