  ...
  const progress = {
    ...
    areaStats: {
      'matematicas': {
        ...
        percentage: areaStats['Matemáticas'].total > 0 
      ...
      'lenguaje': {
        ...
        percentage: areaStats['Lectura Crítica'].total > 0
      ...
      'ciencias': {
        ...
        percentage: areaStats['Ciencias Naturales'].total > 0
      ...
      'sociales': {
        ...
        percentage: areaStats['Sociales y Ciudadanas'].total > 0
...
export const getRecommendations = (progress) => {
  ...
  recommendations.push(
    'Realiza simulacros completos para prepararte mejor'
  );
