...
import { PrivateRoute, DemoRoute, DemoTimerBanner } from '@/shared/components';
import { LoginPage, SignupPage, ForgotPasswordPage, ResetPasswordPage, OnboardingPage } from '@/features/auth/pages';
  ...
  return (
    <MainLayout>
      ...
      <Routes>
          ...
          {/* Legal: /privacidad y /terminos (Next.js src/app/privacidad, terminos) */}
