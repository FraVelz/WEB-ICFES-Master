  ...
  return (
    <div className="min-h-dvh bg-linear-to-b from-black via-slate-950 to-black py-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl p-4 sm:p-8 relative z-10">
        <h1 className="text-4xl font-bold mb-4 text-transparent bg-clip-text bg-linear-to-r from-purple-400 to-pink-500 flex items-center gap-3">
        ...
        <div className="space-y-6">
          <p className="text-gray-200 leading-relaxed">Al acceder y utilizar <strong className="text-purple-400">ICFES Master</strong>, aceptas los siguientes Términos y Condiciones.</p>

          <div>
            <h2 className="text-2xl font-bold mt-8 mb-4 text-purple-400">1. Descripción del servicio</h2>
            <p className="text-gray-300 mb-6">ICFES Master es una plataforma educativa diseñada para apoyar la preparación del examen ICFES mediante práctica, seguimiento del progreso y estadísticas académicas.</p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">El usuario es responsable de mantener la confidencialidad de su cuenta y de toda actividad realizada desde ella.</p>
          </div>

          <div>
            <h2 className="text-2xl font-bold mt-8 mb-4 text-purple-400">4. Resultados académicos</h2>
            <div className="bg-yellow-500/20 border border-yellow-500/50 rounded-lg p-4 mb-6">
              <p className="text-gray-200"><strong className="text-yellow-300">No garantiza resultados específicos en el examen ICFES</strong>, ya que dependen de múltiples factores.</p>
            </div>
          </div>

          <div>
            <h2 className="text-2xl font-bold mt-8 mb-4 text-purple-400">5. Disponibilidad del servicio</h2>
            <p className="text-gray-300 mb-6">El servicio puede ser modificado, suspendido o actualizado en cualquier momento.</p>
          </div>

          <div>
            <h2 className="text-2xl font-bold mt-8 mb-4 text-purple-400">6. Monetización</h2>
            <p className="text-gray-300 mb-6">La plataforma es 100% gratuita.</p>
          </div>

          <div>
            <h2 className="text-2xl font-bold mt-8 mb-4 text-purple-400">7. Propiedad intelectual</h2>
            <p className="text-gray-300 mb-6">Todo el contenido de ICFES Master pertenece a sus desarrolladores.</p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">Estos términos se rigen por las leyes de la <strong>República de Colombia</strong>.</p>
          </div>

          <div>
            <h2 className="text-2xl font-bold mt-8 mb-4 text-purple-400">10. Contacto</h2>
            <p className="text-gray-300 mb-6"><a href="mailto:fravelz@proton.me" className="text-purple-400 hover:text-purple-300 underline">fravelz@proton.me</a></p>
          </div>

          <div className="mt-12 pt-8 border-t border-white/10 flex justify-center">
            <Link href="/" className="px-8 py-3 bg-linear-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white font-semibold rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/50 flex items-center gap-2">
              ← Volver al Inicio
            </Link>
          </div>
        </div>
