    ...
    <>
      ...
      <main id="main-content" className={cn('relative px-4 py-12 sm:px-6 lg:px-8', FULL_PAGE_SHELL_CLASS)}>
        <div className="pointer-events-none fixed inset-0 z-0 motion-reduce:animate-none">
          ...
          />
          <div className="absolute right-1/4 bottom-1/3 h-96 w-96 animate-pulse rounded-full bg-purple-500/20 blur-3xl motion-reduce:animate-none" />
        </div>
        ...
        >
          ...
          <div className="space-y-6">
            <p className="text-on-surface leading-relaxed">
              ...
              nuestros usuarios. Esta Política de Privacidad explica cómo recopilamos, usamos y protegemos la
              información cuando utilizas nuestra aplicación y sitio web, enfocados en la preparación académica para el
              examen ICFES.
            </p>
            ...
            <div>
              ...
              <ul className="text-on-surface-muted mb-4 list-inside list-disc space-y-2">
                ...
                <li>
                  Métricas de rendimiento (Web Vitals) mediante <strong>Vercel Speed Insights</strong>, sin identificar
